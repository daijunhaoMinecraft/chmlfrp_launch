...
notification.notify(title = f"隧道正在启动--{usertunnel_info[get_usertunnel_select]['name']}",message = f"隧道ip地址:{usertunnel_info[get_usertunnel_select]['ip']}",app_icon = f"{pathx}\\system_info.ico",timeout = 10)
sys.exit()
